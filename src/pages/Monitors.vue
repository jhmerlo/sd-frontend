<template>
  <q-page style="min-height: 0px !important">
    ...
    <q-page-sticky position="bottom-right" :offset="[18, 18]">
      <q-btn @click="showMonitorDialog(null)" fab icon="add" color="primary">
      </q-btn>
    </q-page-sticky>
  </q-page>
</template>
...
export default {
  ...
  methods: {
    async getIndex (props) {
      ...
      const { data } = await this.$axios.get('monitors', { 
        params: { 
          page,
          ...this.filters
        }
    ...
    showCommentsDialog (commentable) {
      this.$q.dialog({
        ...
        commentableType: "App\\Models\\Monitor",
        commentable
      }).onOk((comments) => {
